let ping,fetch,sslCertificate,extractDomain,WebSocket,Traceroute,getRange,subnetData;_fd1‍.w("ping",[["default",["ping"],function(v){ping=v}]]);_fd1‍.w("node-fetch",[["default",["fetch"],function(v){fetch=v}]]);_fd1‍.w("get-ssl-certificate",[["default",["sslCertificate"],function(v){sslCertificate=v}]]);_fd1‍.w("extract-domain",[["default",["extractDomain"],function(v){extractDomain=v}]]);_fd1‍.w("./web-socket.js",[["default",["WebSocket"],function(v){WebSocket=v}]]);_fd1‍.w("nodejs-traceroute",[["default",["Traceroute"],function(v){Traceroute=v}]]);_fd1‍.w("./functions",[["getRange",["getRange"],function(v){getRange=v}],["subnetData",["subnetData"],function(v){subnetData=v}]]);
...
netScan.traceroute('192.168.1.254',(hop)=>{
  _fd1‍.g.console.log(hop)
})
