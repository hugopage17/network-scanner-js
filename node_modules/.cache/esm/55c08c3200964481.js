let ping,fetch,sslCertificate,extractDomain,WebSocket,Traceroute,getRange,subnetData;_009‍.w("ping",[["default",["ping"],function(v){ping=v}]]);_009‍.w("node-fetch",[["default",["fetch"],function(v){fetch=v}]]);_009‍.w("get-ssl-certificate",[["default",["sslCertificate"],function(v){sslCertificate=v}]]);_009‍.w("extract-domain",[["default",["extractDomain"],function(v){extractDomain=v}]]);_009‍.w("./web-socket.js",[["default",["WebSocket"],function(v){WebSocket=v}]]);_009‍.w("nodejs-traceroute",[["default",["Traceroute"],function(v){Traceroute=v}]]);_009‍.w("./functions",[["getRange",["getRange"],function(v){getRange=v}],["subnetData",["subnetData"],function(v){subnetData=v}]]);
...
const arr = [1,2,4,10]
let newArr = arr.filter(num => {return num < 10})
_009‍.g.console.log(newArr);
