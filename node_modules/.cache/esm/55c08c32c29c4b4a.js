let ping,fetch,sslCertificate,extractDomain,WebSocket,getRange,subnetData;_c29‍.w("ping",[["default",["ping"],function(v){ping=v}]]);_c29‍.w("node-fetch",[["default",["fetch"],function(v){fetch=v}]]);_c29‍.w("get-ssl-certificate",[["default",["sslCertificate"],function(v){sslCertificate=v}]]);_c29‍.w("extract-domain",[["default",["extractDomain"],function(v){extractDomain=v}]]);_c29‍.w("./web-socket.js",[["default",["WebSocket"],function(v){WebSocket=v}]]);_c29‍.w("./functions",[["getRange",["getRange"],function(v){getRange=v}],["subnetData",["subnetData"],function(v){subnetData=v}]]);
...
netScan.ipScan('10.167.4.40-44', (node)=>{
  _c29‍.g.console.log(node);
})
